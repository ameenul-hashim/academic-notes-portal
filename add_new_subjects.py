...
new_subjects = [
    {
        "id": "sociology",
        "name": "Sociology",
        "en": "sociology-en.html",
        "ml": "sociology-ml.html",
        "file": "sociology.html"
    },
    {
        "id": "micro-economics",
        "name": "Micro Economics",
        "en": "micro-economics-en.html",
        "ml": "micro-economics-ml.html",
        "file": "micro-economics.html"
    }
]
...
# Inject cards before the end of the grid (last subject card was Philosophy of Artificial Intelligence etc)
# Find the end of the grid (before </main> or last </a>)
index_content = index_content.replace('<!-- Subject Card 6 -->', '<!-- Subject Card 6 -->\n' + subject_cards)
...
print("Updated index.html with new subjects and status rows.")
